...
namespace FishCrafting.Content.Mounts
{
    public class FishyCarrot : ModMount
    {
		...
		public override void SetStaticDefaults()
		{
			...
			MountData.buff = ModContent.BuffType<Buffs.FishyCarrot>(); // The ID number of the buff assigned to the mount.

			// Effects
			//MountData.spawnDust = Dust.dustWater(); //ModContent.DustType<Dusts.Sparkle>(); // The ID of the dust spawned when mounted or dismounted.
